/*
 * $Id: cfuncs.c 3923 2026-09-07 06:51:54Z itamarlins $
 *
...
/*
 * UTF-8 case conversion helpers, defined in hcedit_l.c (built by the
 * same procmisc.hbp target).  Declared here because the original HWGUI
 * header that exposed them was not carried over during the GTK4 port.
 */
extern int utf8lcstr( const char *szSrc, int iSrcLen,
                      char **szDst, int *iDstLen );
extern int utf8ucstr( const char *szSrc, int iSrcLen,
                      char **szDst, int *iDstLen );
 ...
 *   - Windows ANSI    : path converted UTF-8 -> CP_ACP; use hb_parcx()
 *   - Windows UNICODE : path converted UTF-8 -> UTF-16 ; use hb_parcw()
 *===========================================================================*/
HB_FUNC( HWG_CHDIR )
{
