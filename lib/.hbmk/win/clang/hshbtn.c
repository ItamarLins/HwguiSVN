 ...
 * Generated C source from "source\winapi\hshbtn.prg"
 */
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_HSHBTN, "source\\winapi\\hshbtn.prg", 0x0, 0x0003 )
...
HB_FUNC( HSHADEBUTTON )
{
	...
	{
		149,3,0,116,33,0,36,21,0,103,1,0,100,8,
...
HB_FUNC_STATIC( HSHADEBUTTON_PAINT )
{
	static const HB_BYTE pcode[] =
	{
		13,3,0,36,59,0,176,20,0,12,0,80,1,36,
		60,0,176,21,0,48,22,0,102,112,0,95,1,12,
		2,80,2,36,62,0,48,23,0,102,112,0,121,8,
		28,13,36,63,0,48,24,0,102,122,112,1,73,36,
		66,0,48,25,0,102,112,0,28,62,36,69,0,48,
		...
		36,71,0,92,16,80,3,36,74,0,176,27,0,48,
		19,0,102,112,0,95,2,95,3,20,3,36,76,0,
		48,28,0,102,95,2,112,1,73,36,78,0,176,29,
		0,48,22,0,102,112,0,95,1,20,2,36,80,0,
		100,110,7
	};
...
HB_FUNC_STATIC( HSHADEBUTTON_END )
{
	static const HB_BYTE pcode[] =
	{
		36,84,0,48,30,0,48,15,0,102,112,0,112,0,
		73,36,85,0,176,31,0,48,19,0,102,112,0,12,
		1,31,27,36,86,0,176,32,0,48,19,0,102,112,
		0,20,1,36,87,0,48,16,0,102,100,112,1,73,
		36,90,0,100,110,7
	};
